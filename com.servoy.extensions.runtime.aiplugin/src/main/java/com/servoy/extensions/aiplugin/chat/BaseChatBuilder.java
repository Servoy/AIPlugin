 ...
 * <li>Allows dynamic creation and registration of custom tools using
...
public class BaseChatBuilder<T extends BaseChatBuilder<T>> {
	...
	/**
	 * Creates and configures an AI assistant builder, injecting built-in and custom
	 * tools as needed.
	 *
	...
	/**
	 * Registers a tool specification and its executor for the AI agent. Handles
	 * argument mapping and execution for tool requests.
	 *
